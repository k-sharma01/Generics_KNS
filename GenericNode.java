/**
 * This class models a Node object which contains a data of type T (Generic). Each
 * node has its internal data (of type T) and pointers to the next 
 * node in the list.
 * 
...
public class GenericNode <T> {
	...
	/**
	 * This method sets the data of the object to an object of type T.
	 * @param data
	 */
